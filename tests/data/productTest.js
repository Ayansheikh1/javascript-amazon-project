...
describe('test suite: Appliance', () => {
  ...
  it('display instruction link in extra info',() => {
  ...
  it('display warranty link in extra info',() => {
    expect(appliance.extraInfoHTML()).toContain(
